...
echo "   ssh -i ~/.ssh/vm-k8s.pem -L 8080:localhost:8080 -L 5000:localhost:5000 -L 9000:localhost:9000 -L 9001:localhost:9001 -L 9090:localhost:9090 -L 3000:localhost:3000 -L 8000:localhost:8000 -L 7860:localhost:7860 azureuser@40.82.143.98"
echo ""
